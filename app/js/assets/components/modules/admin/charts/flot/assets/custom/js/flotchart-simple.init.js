(function($)
{
	...
	charts.chart_simple = 
	{
		...
		init: function()
		{
			...
			if (this.plot == null)
			{
			 	this.data.d1 = [ [1, 1], [2, 500], [3, 1000], [4, 1500], [5, 2000], [6, 2250], [7, 2500], [8, 2520], [9, 2700], [10, 2570], [11, 2700], [12, 3300] ];
			 	this.data.d2 = [ [1, 1], [2, 300], [3, 600], [4, 1200], [5, 2200], [6, 2500], [7, 2600], [8, 2360], [9, 2200], [10, 2460], [11, 3000], [12, 3400] ];
			}
			this.plot = $.plot(
				$(this.placeholder),
	           	[{
