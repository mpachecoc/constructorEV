<?php
    ...
    class ApuEquipment {
        // DB Conn
        private $conn;
        private $table = 'apu_equipment_machinery';

        // APU-Equipments Properties
        public $proj_id;
        public $apu_id;
        public $equip_id;
        public $cant;
        ...
        public function read_single() {
            ...
            $stmt->bindParam(3, $this->equip_id);
            ...
            // Set properties
            $this->cant = $row['apuEquipCant'];
            $this->precio_productivo = $row['apuEquipPrecioProductivo'];
            $this->costo_total = $row['apuEquipCostoTotal'];
        }

        /** GET by Project and APU (APU-Equipments) */
        ...
        public function create() {
            ...
            $query = 'INSERT INTO '.$this->table.' SET 
                      ...
                      equipID = :equip_id, 
                      apuEquipCant = :cant,
                      apuEquipPrecioProductivo = :precio_productivo,
                      apuEquipCostoTotal = :costo_total';
            ...
            $this->equip_id = htmlspecialchars(strip_tags($this->equip_id));
            ...
            $stmt->bindParam(':equip_id', $this->equip_id);
