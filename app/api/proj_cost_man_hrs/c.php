<?php
    ...
    /**
     *  Create a Project Cost Man Hrs. (c)
     */
    ...
    // Get raw json project Cost Man Hrs. data
    ...
    // Create Project (Cost Man Hrs.)
    if ($proj_cmh->create()) {
        http_response_code(200);
        echo json_encode(
            array('message' => 'Project (Cost Man Hrs.) Created Successfully.')
        );
    }else{
        http_response_code(409);
        echo json_encode(
            array('message' => 'Project (Cost Man Hrs.) Not Created.')
        );
    }